...
class _TripFormPageState extends State<TripFormPage> {
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: _tripType == 'contract' ? const Color(0xFF4B39EF).withValues(alpha: 0.1) : Colors.transparent,
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: _tripType == 'contract' ? const Color(0xFF4B39EF) : Colors.grey.withValues(alpha: 0.3),
                        ),
                      ),
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: _tripType == 'contract' ? const Color(0xFF4B39EF) : Colors.grey,
                                width: 2,
                              ),
                            ),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: _tripType == 'savari' ? const Color(0xFF4B39EF).withValues(alpha: 0.1) : Colors.transparent,
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: _tripType == 'savari' ? const Color(0xFF4B39EF) : Colors.grey.withValues(alpha: 0.3),
                        ),
                      ),
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(
                                color: _tripType == 'savari' ? const Color(0xFF4B39EF) : Colors.grey,
                                width: 2,
                              ),
                            ),
  ...
  Widget _buildRateBreakup() {
    ...
    if (distance <= 0 || _selectedVehicleId == null) return const SizedBox();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.calculate, size: 16, color: Color(0xFF1D4ED8)),
              const SizedBox(width: 8),
              Text(
                'നിരക്ക് വിവരണം',
                style: GoogleFonts.notoSansMalayalam(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: [
                      DropdownMenuItem(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.add, size: 16, color: Color(0xFF4B39EF)),
                            const SizedBox(width: 8),
  ...
  Widget _buildContractDistanceInfo() {
    ...
    if (distance <= 0 || _selectedContractId == null) return const SizedBox();
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isExceeded ? const Color(0xFFFECACA) : const Color(0xFFBBF7D0),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(
                ...
                size: 16,
                color: isExceeded ? const Color(0xFFDC2626) : const Color(0xFF059669),
              ),
              const SizedBox(width: 8),
              Text(
                'മൊത്തം ദൂരം: ${distance.toStringAsFixed(1)} കി.മീ',
          ...
          Text(
            ...
            style: GoogleFonts.notoSansMalayalam(
              fontSize: 12,
              color: isExceeded ? const Color(0xFFB91C1C) : const Color(0xFF047857),
            ),
          ),
          if (isExceeded) ...[
            const SizedBox(height: 4),
