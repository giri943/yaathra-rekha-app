...
class _VehiclesPageState extends State<VehiclesPage> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.currency_rupee, size: 14, color: Color(0xFF1D4ED8)),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.speed, size: 14, color: Color(0xFF1D4ED8)),
                                const SizedBox(width: 4),
                                Text(
                                  'ഓരോ കി.മീ',
                                  style: GoogleFonts.notoSansMalayalam(
  ...
  Widget _buildDateCard({
    ...
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: isExpiring ? const Color(0xFFFEF3C7) : const Color(0xFFF8FAFC),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isExpiring ? const Color(0xFFFDE68A) : const Color(0xFFE2E8F0),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(
                icon,
                size: 16,
                color: isExpiring ? const Color(0xFFD97706) : const Color(0xFF64748B),
              ),
          ...
          Text(
            ...
            style: GoogleFonts.notoSansMalayalam(
              fontSize: 12,
              fontWeight: FontWeight.w600,
              color: isExpiring ? const Color(0xFF92400E) : const Color(0xFF1E293B),
            ),
          ),
        ],
      ),
