                ...
                PopupMenuButton(
                  ...
                  itemBuilder: (context) => [
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.edit, size: 18, color: Color(0xFF059669)),
                          SizedBox(width: 8),
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  padding: EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: isExpired ? Color(0xFFFEE2E2) : isExpiringSoon ? Color(0xFFFEF3C7) : Color(0xFFF8FAFC),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: isExpired ? Color(0xFFFECACA) : isExpiringSoon ? Color(0xFFFDE68A) : Color(0xFFE2E8F0),
                    ),
                  ),
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color: isExpired ? Color(0xFFDC2626) : isExpiringSoon ? Color(0xFFD97706) : Color(0xFF64748B),
                      ),
                      SizedBox(width: 8),
                      Text(
                        'കരാർ അവസാന തീയതി:',
                      ...
                      Text(
                        ...
                        style: GoogleFonts.notoSansMalayalam(
                          fontSize: 12,
                          fontWeight: FontWeight.w600,
                          color: isExpired ? Color(0xFF991B1B) : isExpiringSoon ? Color(0xFF92400E) : Color(0xFF1E293B),
                        ),
                      ),
                    ],
                  ),
